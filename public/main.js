...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Thumbnails = __webpack_require__(302);

	var _Thumbnails2 = _interopRequireDefault(_Thumbnails);

	var _Lightbox = __webpack_require__(303);
	...
	var App = function () {
	  function App(_ref) {
	    ...
	    this.thumbnails = new _Thumbnails2.default(this.onThumbnailClick.bind(this));
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      (0, _api.fetchImages)({ subReddit: this.subReddit, page: this.page }).then(function (images) {
	        _this.images = images;
	        _this.thumbnails.render(_this.images);
	      });
	    }
	  }, {
	    key: 'onLightboxPrev',
	    value: function onLightboxPrev() {
	    ...
	    key: 'onLightboxClear',
	    value: function onLightboxClear() {
	      this.activeImageIndex = null;
	    }
	  }, {
	    key: 'cacheElements',
	    ...
	    key: 'onGlobalKeydown',
	    value: function onGlobalKeydown(event) {
	      switch (event.key) {
	        case 'Escape':
	          this.lightbox.clear();
	          break;
	    ...
	    key: 'onSubredditKeydown',
	    value: function onSubredditKeydown(event) {
	      if (event.key === 'Enter') {
	    ...
	    value: function onThumbnailClick(_ref2, index) {
	      var link = _ref2.link;
	      var mp4 = _ref2.mp4;
	    ...
	    key: 'onPagePrevClick',
	    value: function onPagePrevClick() {
	    ...
	    key: 'onPageNextClick',
	    value: function onPageNextClick() {
	      this.page++;
	      this.updatePageNumber();
	      this.render();
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ImageModel = __webpack_require__(301);
	...
	// Fetch polyfill
	var IMGUR_CLIENT_ID = '7e098583985e3a0'; // Babel polyfill includes promises - required for whatwg-fetch
	function fetchImages(_ref) {
	  ...
	  return fetch('https://api.imgur.com/3/gallery/r/' + subReddit + '/top/all/' + page, {
	    ...
	    return json.data.map(function (imageData) {
	      return new _ImageModel2.default(imageData);
	      ...
	      if (images.length) {
	        images.forEach(function (image, index) {
	          ...
	          thumbnailDiv.addEventListener('click', function () {
	            return _this.onThumbnailClick(image, index);
	          });

	          _this.el.appendChild(thumbnailDiv);
	        });
	      } else {
...
/***/ function(module, exports) {
	...
	var Lightbox = function () {
	  function Lightbox(_ref) {
	    var onPrevImageClick = _ref.onPrevImageClick;
	    var onNextImageClick = _ref.onNextImageClick;
